...
<!-- commands -->
<<<<<<< HEAD
* [`sfdx-git gpalm:ci:build [-f <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`](#sfdx-git-gpalmcibuild--f-string--v-string--u-string---apiversion-string---json---loglevel-tracedebuginfowarnerrorfataltracedebuginfowarnerrorfatal)
...
## `sfdx-git gpalm:ci:build [-f <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel trace|debug|info|warn|error|fatal|TRACE|DEBUG|INFO|WARN|ERROR|FATAL]`

```
USAGE
  $ sfdx-git gpalm:ci:build [-f <string>] [-v <string>] [-u <string>] [--apiversion <string>] [--json] [--loglevel 
...
_See code: [src/commands/gpalm/ci/build.ts](https://github.com/gavinhughpalmer/sfdx-git/blob/v0.0.0/src/commands/gpalm/ci/build.ts)_
